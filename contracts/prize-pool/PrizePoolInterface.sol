...
interface PrizePoolInterface {
  ...
  function captureAwardBalanceComplete(address ticket) external;

  function upDataSortitionSumTrees(address _ticket,address _address,uint256 _amount) external;
