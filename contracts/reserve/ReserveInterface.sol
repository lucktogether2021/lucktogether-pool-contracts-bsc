...
interface ReserveInterface {
  ...
  function setWithdrawReserveMantissa(address[] calldata sources,  uint224[] calldata _reserveRates) external;
  ...
  function withdrawReserve(address prizePool) external returns (uint256);
  ...
  event WithdrawReserveReserveRateMantissaSet(address indexed withdrawReserve, uint256 rateMantissa);
